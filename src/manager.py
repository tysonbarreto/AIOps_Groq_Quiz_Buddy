...
class QuizManager:
    ...
    def generate_questions(self, generator:QuestionGenerator, topic:str, question_type:Literal["Multiple Choice","Fill in the blank"], difficulty:str, num_questions:int)->bool:
        self.questions=[]
        self.user_answers=[]
        self.results=[]
